 ...
 * 
 */
package com.java.techhub.security.demo.util;
...
import com.java.techhub.security.demo.repository.UsersRepository;
...
public class PasscodeUdpaterUtil {
	...
	public void onApplicationReady() {
		try {
			...
			log.info("Persisting users data started...");
			...
			log.info("Persisting users data finished...");
		} catch (Exception e) {
